...
echo -e "\e[94m                                                  "
read -p "            Wallet Address  : " -e -i 43mg3kATv2QXYLshERu7jXBWiy29bLxby1wXtsbZa1Z59utNq2YbgATP486pSJz5Ke7R9BeKjC8E2FAHEQnRMxPb7z3YRCe WalletAdd
clear
echo -e "                                                        "
echo -e "\e[94m    :::::::::  :::::::::   ::::::::  :::   :::    "
echo -e "\e[94m    :+:    :+: :+:    :+: :+:    :+: :+:   :+:    "
...
echo -e "\e[94m          XMR Miner Script by _mrzev123_          "
echo -e "\e[94m                                                  "
read -rp "            Thread/s Usage  : " -e -i 2 THREADS
clear
echo -e "                                                        "
echo -e "\e[94m    :::::::::  :::::::::   ::::::::  :::   :::    "
echo -e "\e[94m    :+:    :+: :+:    :+: :+:    :+: :+:   :+:    "
...
echo -e "\e[94m                                                  "
cd /etc
wget --quiet https://raw.githubusercontent.com/mrzev123/XMR_Mining_Ubuntu/master/config.json -O ${CONFIG_NAME}
...
echo -e "\e[94m                                                  "
cd /usr/bin
wget --quiet -O menu "https://raw.githubusercontent.com/mrzev123/XMR-Mining-Script/master/Menu/XMR-Mining-Menu.sh"
wget --quiet -O start "https://raw.githubusercontent.com/mrzev123/XMR-Mining-Script/master/Menu/XMR-Mining-Start.sh"
wget --quiet -O stop "https://raw.githubusercontent.com/mrzev123/XMR-Mining-Script/master/Menu/XMR-Mining-Stop.sh"
wget --quiet -O status "https://raw.githubusercontent.com/mrzev123/XMR-Mining-Script/master/Menu/XMR-Mining-Status.sh"
wget --quiet -O config "https://raw.githubusercontent.com/mrzev123/XMR-Mining-Script/master/Menu/XMR-Mining-Config.sh"
wget --quiet -O logs "https://raw.githubusercontent.com/mrzev123/XMR-Mining-Script/master/Menu/XMR-Mining-Logs.sh"
chmod +x menu
chmod +x start
chmod +x stop
chmod +x status
...
echo 'echo -e "\e[94m    #+#    #+# #+#    #+# #+#    #+#    #+#       "' >> .bashrc
echo 'echo -e "\e[94m    #########  ###    ###  ########     ###       "' >> .bashrc
echo 'echo -e "\e[94m          XMR Miner Script by _mrzev123_          "' >> .bashrc
echo 'echo -e "\e[94m                                                  "' >> .bashrc
